...
class BlurViewer {
  ...
  init() {
    this.blurTemplate = new _templator_js__WEBPACK_IMPORTED_MODULE_0__["Templator"](document.getElementById('blur-template').innerHTML);
...
/*!**************************!*\
  !*** ./src/templator.js ***!
  \**************************/
/*! exports provided: Templator */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Templator", function() { return Templator; });
class Templator {
  constructor(string) {
  ...
  compile(data) {
    ...
    return this.template.replace(/\{\{(.*?)\}\}/g, function (match, keysString) {
      ...
      let value = data; // alert(keys.length)
